...
![image-20230123204025921](https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/1273/image-20230123204025921.png)
...
> 所谓最佳实践，就是使用过程中总结的经验，最好的一种使用方式。自习观察可以发现，`Feign` 的客户端与服务提供者的 `controller` 代码非常相似
