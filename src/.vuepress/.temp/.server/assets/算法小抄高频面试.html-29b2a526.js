...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h2 id="如何高效寻找素数" tabindex="-1"><a class="header-anchor" href="#如何高效寻找素数" aria-hidden="true">#</a> 如何高效寻找素数</h2><div class="hint-container tip"><p class="hint-container-title">素数</p><p>如果一个数只能被1和它本身整除，那么这个数就是素数。</p></div><p>实现一个函数，输入一个正整数<code>n</code>，函数返回区间<code>[2,n)</code>中素数的个数。</p><p>函数签名如下：<code>int countPrimes(int n)</code></p><h3 id="一般实现" tabindex="-1"><a class="header-anchor" href="#一般实现" aria-hidden="true">#</a> 一般实现</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/***
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/codenotes/algdata/lbld/算法小抄高频面试.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _________html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "算法小抄高频面试.html.vue"]]);
export {
